      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 leading-relaxed">
              Your ultimate destination for discovering amazing recipes, cooking tips, 
              and culinary inspiration from around the globe.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Favorites</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 Food App. All rights reserved. Made with ❤️ for food lovers.
          </p>
        </div>
      </div>
    </footer>
